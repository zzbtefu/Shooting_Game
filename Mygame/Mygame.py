...
class BounceOnBoxStrategy:
    ...
    def __call__(self, b):
        ...
        pos = b.pos
        vel = b.vel
        left_wall = b.block_init.pos[0]
        right_wall = b.block_init.pos[0] + b.block_init.width
        top_wall = b.block_init.pos[1]
        bottom_wall = b.block_init.pos[1] + b.block_init.height
...
class Bullet:
    def __init__(self, pos, vel, world, power, block_init, postmove_strategy=None, reflect_box=None):
        self.is_alive = True
        self.pos = pos
        self.vel = vel
        self.world = world
...
class AppMain:
    def __init__(self):
        ...
        self.bullets = []
        self.block_init = Block.__init__
        self.hp_player = 100
        self.hp_enemy = 50
        self.max_bounce = 4
        self.bounce_count = 0
    ...
    def add_bullet(self, image_pos, image_rect):
        ...
        b = Bullet(list(image_rect.center), list(bullet_velocity), self.world, self.bullet_power, self.block_init,\
